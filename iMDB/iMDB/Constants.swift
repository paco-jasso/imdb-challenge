...
class Constants {
    ...
    //This is safe
    static let popularMoviesURL = "https://api.themoviedb.org/3/discover/movie?include_adult=false&include_video=false&language=%@-US&page=1&sort_by=popularity.desc"
